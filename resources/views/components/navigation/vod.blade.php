...
<ul class="ml-4">
    <li>
        ...
        <a class="nav_item{{ in_array(Route::currentRouteName(), ['videos.index', 'videos.show', 'videos.edit', 'videos.create']) ? ' nav_item__selected': '' }}" href="{{ route('videos.index') }}" title="{{ trans('videos.View all videos') }}">{{ trans('videos.Video') }}</a>
