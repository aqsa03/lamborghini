<x-layouts.panel_layout>
    ...
    <div class="body_section">
        ...
        <x-page_title>{{ trans('videos.Videos') }}</x-page_title>
        ...
        <form action="{{ route('videos.index') }}" method="GET" id="myForm">
            <input type="text" id="searchInput" name="search" placeholder="Search by title..." value="{{ $searchTerm }}">
        </form>
        <div class="default_table">
            <ol class="table_list">
                    ...
                    <li class="table_list__row hover:bg-slate-100">
                        ...
                        <div class="table_list__row__cell">
                            <div class="flex gap-2">
                                @if ($video->type != App\Enums\VideoType::EXT_VIEW->value && $video->type != App\Enums\VideoType::PRE_EXISTING->value)
                                    @if (!$video->canPublish())
                ...
                @empty
                    <li class="table_list__row">
                        <div class="table_list__row__cell" colspan="6">No videos found.</div>
                    </li>
                @endforelse
