...
; (() => {
    // const newsCreateForm = new ProgramCreateForm({
    //     form: document.getElementById("news-create-form"),
    //     editorHolderId: "description"
    // });

    // newsCreateForm.setup();
    // window.newsCreateForm = newsCreateForm;
    ...
    let editorData = {};
    const descriptionData = document.getElementById("news_source_description").innerText.trim();
